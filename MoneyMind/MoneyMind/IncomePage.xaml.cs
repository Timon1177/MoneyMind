...
namespace MoneyMind
{
  ...
  {
    public ObservableCollection<EntryBase> Incomes { get; set; } = new();
    public ObservableCollection<EntryBase> FixedExpenses { get; set; } = new();
    public ObservableCollection<EntryBase> OtherExpenses { get; set; } = new();
